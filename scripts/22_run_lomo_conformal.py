...
for lomo in ["A", "B", "C"]:
    ...
    print()
    print("=" * 60)
    print(f"LOMO-{lomo} CONFORMAL PREDICTION")
    print("=" * 60)
...
print()
print("=" * 60)
print("LOMO CONFORMAL PREDICTION COMPLETE")
print("=" * 60)